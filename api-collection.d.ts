...
export interface paths {
  ...
  "/items/company": {
    ...
    get: operations["readItemsCompany"];
    /** Create a new company item. */
    post: operations["createItemsCompany"];
  };
  "/items/company/{id}": {
    /** Retrieve a single company item by unique identifier. */
    get: operations["readSingleItemsCompany"];
    /** Delete an existing company item. */
    delete: operations["deleteSingleItemsCompany"];
    /** Update an existing company item. */
    patch: operations["updateSingleItemsCompany"];
  };
  "/items/company_credits": {
    /** List the company_credits items. */
    get: operations["readItemsCompanyCredits"];
    /** Create a new company_credits item. */
    post: operations["createItemsCompanyCredits"];
  };
  "/items/company_credits/{id}": {
    /** Retrieve a single company_credits item by unique identifier. */
    get: operations["readSingleItemsCompanyCredits"];
    /** Delete an existing company_credits item. */
    delete: operations["deleteSingleItemsCompanyCredits"];
    /** Update an existing company_credits item. */
    patch: operations["updateSingleItemsCompanyCredits"];
  };
  "/items/custom_roles": {
    /** List the custom_roles items. */
    get: operations["readItemsCustomRoles"];
    /** Create a new custom_roles item. */
    post: operations["createItemsCustomRoles"];
  };
  "/items/custom_roles/{id}": {
    /** Retrieve a single custom_roles item by unique identifier. */
    get: operations["readSingleItemsCustomRoles"];
    /** Delete an existing custom_roles item. */
    delete: operations["deleteSingleItemsCustomRoles"];
    /** Update an existing custom_roles item. */
    patch: operations["updateSingleItemsCustomRoles"];
  };
  "/items/custom_roles_modules": {
    /** List the custom_roles_modules items. */
    get: operations["readItemsCustomRolesModules"];
    /** Create a new custom_roles_modules item. */
    post: operations["createItemsCustomRolesModules"];
  };
  "/items/custom_roles_modules/{id}": {
    /** Retrieve a single custom_roles_modules item by unique identifier. */
    get: operations["readSingleItemsCustomRolesModules"];
    /** Delete an existing custom_roles_modules item. */
    delete: operations["deleteSingleItemsCustomRolesModules"];
    /** Update an existing custom_roles_modules item. */
    patch: operations["updateSingleItemsCustomRolesModules"];
  };
  "/items/modules": {
    /** List the modules items. */
    get: operations["readItemsModules"];
    /** Create a new modules item. */
    post: operations["createItemsModules"];
  };
  "/items/modules/{id}": {
    /** Retrieve a single modules item by unique identifier. */
    get: operations["readSingleItemsModules"];
    /** Delete an existing modules item. */
    delete: operations["deleteSingleItemsModules"];
    /** Update an existing modules item. */
    patch: operations["updateSingleItemsModules"];
  };
  "/items/question_groups": {
    /** List the question_groups items. */
    get: operations["readItemsQuestionGroups"];
    /** Create a new question_groups item. */
    post: operations["createItemsQuestionGroups"];
  };
  "/items/question_groups/{id}": {
    /** Retrieve a single question_groups item by unique identifier. */
    get: operations["readSingleItemsQuestionGroups"];
    /** Delete an existing question_groups item. */
    delete: operations["deleteSingleItemsQuestionGroups"];
    /** Update an existing question_groups item. */
    patch: operations["updateSingleItemsQuestionGroups"];
  };
  "/items/questions": {
    /** List the questions items. */
    get: operations["readItemsQuestions"];
    /** Create a new questions item. */
    post: operations["createItemsQuestions"];
  };
  "/items/questions/{id}": {
    /** Retrieve a single questions item by unique identifier. */
    get: operations["readSingleItemsQuestions"];
    /** Delete an existing questions item. */
    delete: operations["deleteSingleItemsQuestions"];
    /** Update an existing questions item. */
    patch: operations["updateSingleItemsQuestions"];
  };
  "/items/question_sets": {
    /** List the question_sets items. */
    get: operations["readItemsQuestionSets"];
    /** Create a new question_sets item. */
    post: operations["createItemsQuestionSets"];
  };
  "/items/question_sets/{id}": {
    /** Retrieve a single question_sets item by unique identifier. */
    get: operations["readSingleItemsQuestionSets"];
    /** Delete an existing question_sets item. */
    delete: operations["deleteSingleItemsQuestionSets"];
    /** Update an existing question_sets item. */
    patch: operations["updateSingleItemsQuestionSets"];
  };
  "/items/roles": {
    /** List the roles items. */
    get: operations["readItemsRoles"];
    /** Create a new roles item. */
    post: operations["createItemsRoles"];
  };
  "/items/roles/{id}": {
    /** Retrieve a single roles item by unique identifier. */
    get: operations["readSingleItemsRoles"];
    /** Delete an existing roles item. */
    delete: operations["deleteSingleItemsRoles"];
    /** Update an existing roles item. */
    patch: operations["updateSingleItemsRoles"];
  };
  "/items/roles_modules": {
    /** List the roles_modules items. */
    get: operations["readItemsRolesModules"];
    /** Create a new roles_modules item. */
    post: operations["createItemsRolesModules"];
  };
  "/items/roles_modules/{id}": {
    /** Retrieve a single roles_modules item by unique identifier. */
    get: operations["readSingleItemsRolesModules"];
    /** Delete an existing roles_modules item. */
    delete: operations["deleteSingleItemsRolesModules"];
    /** Update an existing roles_modules item. */
    patch: operations["updateSingleItemsRolesModules"];
  };
  "/items/tenant": {
    /** List the tenant items. */
    get: operations["readItemsTenant"];
    /** Create a new tenant item. */
    post: operations["createItemsTenant"];
  };
  "/items/tenant/{id}": {
    /** Retrieve a single tenant item by unique identifier. */
    get: operations["readSingleItemsTenant"];
    /** Delete an existing tenant item. */
    delete: operations["deleteSingleItemsTenant"];
    /** Update an existing tenant item. */
    patch: operations["updateSingleItemsTenant"];
  };
  "/items/tenant_credits": {
    /** List the tenant_credits items. */
    get: operations["readItemsTenantCredits"];
    /** Create a new tenant_credits item. */
    post: operations["createItemsTenantCredits"];
  };
  "/items/tenant_credits/{id}": {
    /** Retrieve a single tenant_credits item by unique identifier. */
    get: operations["readSingleItemsTenantCredits"];
    /** Delete an existing tenant_credits item. */
    delete: operations["deleteSingleItemsTenantCredits"];
    /** Update an existing tenant_credits item. */
    patch: operations["updateSingleItemsTenantCredits"];
  };
  "/items/user_company": {
    /** List the user_company items. */
    get: operations["readItemsUserCompany"];
    /** Create a new user_company item. */
    post: operations["createItemsUserCompany"];
  };
  "/items/user_company/{id}": {
    /** Retrieve a single user_company item by unique identifier. */
    get: operations["readSingleItemsUserCompany"];
    /** Delete an existing user_company item. */
    delete: operations["deleteSingleItemsUserCompany"];
    /** Update an existing user_company item. */
    patch: operations["updateSingleItemsUserCompany"];
  };
  "/activity": {
...
export interface components {
  schemas: {
    ...
    ItemsCompany: {
      ...
      tenant?: (string | components["schemas"]["ItemsTenant"]) | null;
    ...
    ItemsCompanyCredits: {
      ...
      balance?: number;
      company?: string | components["schemas"]["ItemsCompany"];
      belongs_to?:
        | (string | components["schemas"]["ItemsTenantCredits"])
        | null;
    };
    ItemsCustomRoles: {
      id?: number;
      tenant?: (string | components["schemas"]["ItemsTenant"]) | null;
      company?: (string | components["schemas"]["ItemsCompany"]) | null;
      user?: string | components["schemas"]["Users"];
      base_role?: (string | components["schemas"]["ItemsRoles"]) | null;
      name?: string | null;
      modules?: (number | components["schemas"]["ItemsCustomRolesModules"])[];
    };
    ItemsCustomRolesModules: {
      id?: number;
      custom_roles_id?:
        | (number | components["schemas"]["ItemsCustomRoles"])
        | null;
    ...
    ItemsRoles: {
      id?: string;
      name?: string | null;
      system_role?: string | components["schemas"]["Roles"];
      modules?: (number | components["schemas"]["ItemsRolesModules"])[];
    };
    ItemsRolesModules: {
      id?: number;
      roles_id?: (string | components["schemas"]["ItemsRoles"]) | null;
      modules_id?: (string | components["schemas"]["ItemsModules"]) | null;
    };
    ItemsTenant: {
      id?: string;
    ...
    ItemsTenantCredits: {
      ...
      company_credits?: (
        | string
        | components["schemas"]["ItemsCompanyCredits"]
      )[];
    };
    ItemsUserCompany: {
      id?: number;
...
export interface operations {
  ...
  readItemsCompany: {
    ...
    responses: {
      ...
      200: {
        content: {
          "application/json": {
            data?: components["schemas"]["ItemsCompany"][];
  ...
  createItemsCompany: {
    ...
    requestBody: {
      content: {
        "application/json":
          | components["schemas"]["ItemsCompany"][]
          | components["schemas"]["ItemsCompany"];
      };
    };
  };
  ...
  updateSingleItemsCompany: {
    ...
    requestBody: {
      content: {
        "application/json": components["schemas"]["ItemsCompany"];
      };
    };
  };
  /** List the company_credits items. */
  readItemsCompanyCredits: {
    parameters: {
      query: {
        /** Control what fields are being returned in the object. */
        fields?: components["parameters"]["Fields"];
    ...
    responses: {
      ...
      200: {
        content: {
          "application/json": {
            data?: components["schemas"]["ItemsCompanyCredits"][];
            meta?: components["schemas"]["x-metadata"];
          };
        };
      };
  ...
  /** Delete an existing company_credits item. */
  deleteSingleItemsCompanyCredits: {
    parameters: {
      path: {
        /** Index of the item. */
        id: number | string;
  ...
  /** Update an existing company_credits item. */
  updateSingleItemsCompanyCredits: {
    parameters: {
      query: {
        /** Control what fields are being returned in the object. */
        fields?: components["parameters"]["Fields"];
    ...
    requestBody: {
      content: {
        "application/json": components["schemas"]["ItemsCompanyCredits"];
      };
    };
  };
  /** List the custom_roles items. */
  readItemsCustomRoles: {
    parameters: {
      query: {
        /** Control what fields are being returned in the object. */
        fields?: components["parameters"]["Fields"];
    ...
    responses: {
      ...
      200: {
        content: {
          "application/json": {
            data?: components["schemas"]["ItemsCustomRoles"][];
            meta?: components["schemas"]["x-metadata"];
          };
        };
      };
  ...
  createItemsCustomRoles: {
    ...
    requestBody: {
      content: {
        "application/json":
          | components["schemas"]["ItemsCustomRoles"][]
          | components["schemas"]["ItemsCustomRoles"];
      };
    };
  };
  /** Retrieve a single custom_roles item by unique identifier. */
  readSingleItemsCustomRoles: {
    parameters: {
      query: {
        /** Control what fields are being returned in the object. */
        fields?: components["parameters"]["Fields"];
  ...
  updateSingleItemsCustomRoles: {
    ...
    requestBody: {
      content: {
        "application/json": components["schemas"]["ItemsCustomRoles"];
      };
    };
  };
  /** List the custom_roles_modules items. */
  readItemsCustomRolesModules: {
    parameters: {
      query: {
        /** Control what fields are being returned in the object. */
        fields?: components["parameters"]["Fields"];
    ...
    responses: {
      ...
      200: {
        content: {
          "application/json": {
            data?: components["schemas"]["ItemsCustomRolesModules"][];
            meta?: components["schemas"]["x-metadata"];
          };
        };
      };
  ...
  createItemsCustomRolesModules: {
    ...
    requestBody: {
      content: {
        "application/json":
          | components["schemas"]["ItemsCustomRolesModules"][]
          | components["schemas"]["ItemsCustomRolesModules"];
      };
    };
  };
  /** Retrieve a single custom_roles_modules item by unique identifier. */
  readSingleItemsCustomRolesModules: {
    parameters: {
      query: {
        /** Control what fields are being returned in the object. */
        fields?: components["parameters"]["Fields"];
  ...
  /** Delete an existing custom_roles_modules item. */
  deleteSingleItemsCustomRolesModules: {
    parameters: {
      path: {
        /** Index of the item. */
        id: number | string;
  ...
  /** Update an existing custom_roles_modules item. */
  updateSingleItemsCustomRolesModules: {
    parameters: {
      query: {
        /** Control what fields are being returned in the object. */
        fields?: components["parameters"]["Fields"];
    ...
    requestBody: {
      content: {
        "application/json": components["schemas"]["ItemsCustomRolesModules"];
      };
    };
  };
  /** List the modules items. */
  ...
  createItemsModules: {
    ...
    requestBody: {
      content: {
        "application/json":
          | components["schemas"]["ItemsModules"][]
          | components["schemas"]["ItemsModules"];
      };
    };
  };
  ...
  readItemsQuestionGroups: {
    ...
    responses: {
      ...
      200: {
        content: {
          "application/json": {
            data?: components["schemas"]["ItemsQuestionGroups"][];
            meta?: components["schemas"]["x-metadata"];
          };
        };
      };
  ...
  createItemsQuestionGroups: {
    ...
    requestBody: {
      content: {
        "application/json":
          | components["schemas"]["ItemsQuestionGroups"][]
          | components["schemas"]["ItemsQuestionGroups"];
      };
    };
  };
  /** Retrieve a single question_groups item by unique identifier. */
  readSingleItemsQuestionGroups: {
    parameters: {
      query: {
        /** Control what fields are being returned in the object. */
        fields?: components["parameters"]["Fields"];
  ...
  /** Delete an existing question_groups item. */
  deleteSingleItemsQuestionGroups: {
    parameters: {
      path: {
        /** Index of the item. */
        id: number | string;
  ...
  /** Update an existing question_groups item. */
  updateSingleItemsQuestionGroups: {
    parameters: {
      query: {
        /** Control what fields are being returned in the object. */
        fields?: components["parameters"]["Fields"];
    ...
    requestBody: {
      content: {
        "application/json": components["schemas"]["ItemsQuestionGroups"];
      };
    };
  };
  /** List the questions items. */
  readItemsQuestions: {
    ...
    responses: {
      ...
      200: {
        content: {
          "application/json": {
            data?: components["schemas"]["ItemsQuestions"][];
            meta?: components["schemas"]["x-metadata"];
          };
        };
      };
  ...
  createItemsQuestions: {
    ...
    requestBody: {
      content: {
        "application/json":
          | components["schemas"]["ItemsQuestions"][]
          | components["schemas"]["ItemsQuestions"];
      };
    };
  };
  /** Retrieve a single questions item by unique identifier. */
  readSingleItemsQuestions: {
    parameters: {
      query: {
        /** Control what fields are being returned in the object. */
        fields?: components["parameters"]["Fields"];
  ...
  updateSingleItemsQuestions: {
    ...
    requestBody: {
      content: {
        "application/json": components["schemas"]["ItemsQuestions"];
      };
    };
  };
  /** List the question_sets items. */
  readItemsQuestionSets: {
    parameters: {
      query: {
        /** Control what fields are being returned in the object. */
        fields?: components["parameters"]["Fields"];
    ...
    responses: {
      ...
      200: {
        content: {
          "application/json": {
            data?: components["schemas"]["ItemsQuestionSets"][];
            meta?: components["schemas"]["x-metadata"];
          };
        };
      };
  ...
  createItemsQuestionSets: {
    ...
    requestBody: {
      content: {
        "application/json":
          | components["schemas"]["ItemsQuestionSets"][]
          | components["schemas"]["ItemsQuestionSets"];
      };
    };
  };
  /** Retrieve a single question_sets item by unique identifier. */
  readSingleItemsQuestionSets: {
    parameters: {
      query: {
        /** Control what fields are being returned in the object. */
        fields?: components["parameters"]["Fields"];
  ...
  updateSingleItemsQuestionSets: {
    ...
    requestBody: {
      content: {
        "application/json": components["schemas"]["ItemsQuestionSets"];
      };
    };
  };
  /** List the roles items. */
  readItemsRoles: {
    ...
    responses: {
      ...
      200: {
        content: {
          "application/json": {
            data?: components["schemas"]["ItemsRoles"][];
            meta?: components["schemas"]["x-metadata"];
          };
        };
      };
  ...
  createItemsRoles: {
    ...
    requestBody: {
      content: {
        "application/json":
          | components["schemas"]["ItemsRoles"][]
          | components["schemas"]["ItemsRoles"];
      };
    };
  };
  /** Retrieve a single roles item by unique identifier. */
  readSingleItemsRoles: {
    parameters: {
      query: {
        /** Control what fields are being returned in the object. */
        fields?: components["parameters"]["Fields"];
  ...
  updateSingleItemsRoles: {
    ...
    requestBody: {
      content: {
        "application/json": components["schemas"]["ItemsRoles"];
      };
    };
  };
  /** List the roles_modules items. */
  readItemsRolesModules: {
    parameters: {
      query: {
        /** Control what fields are being returned in the object. */
        fields?: components["parameters"]["Fields"];
    ...
    responses: {
      ...
      200: {
        content: {
          "application/json": {
            data?: components["schemas"]["ItemsRolesModules"][];
            meta?: components["schemas"]["x-metadata"];
          };
        };
      };
  ...
  createItemsRolesModules: {
    ...
    requestBody: {
      content: {
        "application/json":
          | components["schemas"]["ItemsRolesModules"][]
          | components["schemas"]["ItemsRolesModules"];
      };
    };
  };
  /** Retrieve a single roles_modules item by unique identifier. */
  readSingleItemsRolesModules: {
    parameters: {
      query: {
        /** Control what fields are being returned in the object. */
        fields?: components["parameters"]["Fields"];
  ...
  updateSingleItemsRolesModules: {
    ...
    requestBody: {
      content: {
        "application/json": components["schemas"]["ItemsRolesModules"];
      };
    };
  };
  /** List the tenant items. */
  readItemsTenant: {
    ...
    responses: {
      ...
      200: {
        content: {
          "application/json": {
            data?: components["schemas"]["ItemsTenant"][];
            meta?: components["schemas"]["x-metadata"];
          };
        };
      };
  ...
  createItemsTenant: {
    ...
    requestBody: {
      content: {
        "application/json":
          | components["schemas"]["ItemsTenant"][]
          | components["schemas"]["ItemsTenant"];
      };
    };
  };
  /** Retrieve a single tenant item by unique identifier. */
  readSingleItemsTenant: {
    parameters: {
      query: {
        /** Control what fields are being returned in the object. */
        fields?: components["parameters"]["Fields"];
  ...
  updateSingleItemsTenant: {
    ...
    requestBody: {
      content: {
        "application/json": components["schemas"]["ItemsTenant"];
      };
    };
  };
  /** List the tenant_credits items. */
  readItemsTenantCredits: {
    parameters: {
      query: {
        /** Control what fields are being returned in the object. */
        fields?: components["parameters"]["Fields"];
    ...
    responses: {
      ...
      200: {
        content: {
          "application/json": {
            data?: components["schemas"]["ItemsTenantCredits"][];
            meta?: components["schemas"]["x-metadata"];
          };
        };
      };
  ...
  createItemsTenantCredits: {
    ...
    requestBody: {
      content: {
        "application/json":
          | components["schemas"]["ItemsTenantCredits"][]
          | components["schemas"]["ItemsTenantCredits"];
      };
    };
  };
  /** Retrieve a single tenant_credits item by unique identifier. */
  readSingleItemsTenantCredits: {
    parameters: {
      query: {
        /** Control what fields are being returned in the object. */
        fields?: components["parameters"]["Fields"];
  ...
  /** Delete an existing tenant_credits item. */
  deleteSingleItemsTenantCredits: {
    parameters: {
      path: {
        /** Index of the item. */
        id: number | string;
  ...
  /** Update an existing tenant_credits item. */
  updateSingleItemsTenantCredits: {
    parameters: {
      query: {
        /** Control what fields are being returned in the object. */
        fields?: components["parameters"]["Fields"];
    ...
    requestBody: {
      content: {
        "application/json": components["schemas"]["ItemsTenantCredits"];
      };
    };
  };
  /** List the user_company items. */
  readItemsUserCompany: {
    parameters: {
      query: {
        /** Control what fields are being returned in the object. */
        fields?: components["parameters"]["Fields"];
    ...
    responses: {
      ...
      200: {
        content: {
          "application/json": {
            data?: components["schemas"]["ItemsUserCompany"][];
            meta?: components["schemas"]["x-metadata"];
          };
        };
      };
  ...
  createItemsUserCompany: {
    ...
    requestBody: {
      content: {
        "application/json":
          | components["schemas"]["ItemsUserCompany"][]
          | components["schemas"]["ItemsUserCompany"];
      };
    };
  };
  /** Retrieve a single user_company item by unique identifier. */
  readSingleItemsUserCompany: {
    parameters: {
      query: {
        /** Control what fields are being returned in the object. */
        fields?: components["parameters"]["Fields"];
  ...
  updateSingleItemsUserCompany: {
    ...
    requestBody: {
      content: {
        "application/json": components["schemas"]["ItemsUserCompany"];
      };
    };
  };
  /** Returns a list of activity actions. */
...
export type ApiCollections = {
  ...
  company_credits: components["schemas"]["ItemsCompanyCredits"];
  custom_roles: components["schemas"]["ItemsCustomRoles"];
  custom_roles_modules: components["schemas"]["ItemsCustomRolesModules"];
  modules: components["schemas"]["ItemsModules"];
  question_groups: components["schemas"]["ItemsQuestionGroups"];
  questions: components["schemas"]["ItemsQuestions"];
  question_sets: components["schemas"]["ItemsQuestionSets"];
  roles: components["schemas"]["ItemsRoles"];
  roles_modules: components["schemas"]["ItemsRolesModules"];
  tenant: components["schemas"]["ItemsTenant"];
  tenant_credits: components["schemas"]["ItemsTenantCredits"];
  user_company: components["schemas"]["ItemsUserCompany"];
